...
/* harmony import */ var _helper_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helper/index */ "./resources/js/helper/index.js");
/**
...
window.helper = _helper_index__WEBPACK_IMPORTED_MODULE_0__["default"];
document.addEventListener("DOMContentLoaded", _helper_index__WEBPACK_IMPORTED_MODULE_0__["default"].onLoad);

/***/ }),

/***/ "./resources/js/helper/MaskHelper.js":
/*!*******************************************!*\
  !*** ./resources/js/helper/MaskHelper.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "createAllMaskFromDataInput": () => (/* binding */ createAllMaskFromDataInput)
/* harmony export */ });
...
var createMask = function createMask(selectors, opts) {
  /**
   * Mark: Para o número de uma OS
   */
  try {
    return (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(selectors, opts);
  } catch (e) {
...
var createAllMaskFromDataInput = function createAllMaskFromDataInput() {
  var elementos = document.querySelectorAll('[data-mask]');
  Array.from(elementos).map(function (item) {
    createMask(item, {
...
/***/ "./resources/js/helper/autocomplete.js":
/*!*********************************************!*\
  !*** ./resources/js/helper/autocomplete.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var enableAutoComplete = function enableAutoComplete() {
  document.querySelectorAll('select.autocomplete').forEach(function (select) {
...
/* harmony export */ });
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modal */ "./resources/js/helper/modal.js");
/* harmony import */ var _mask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mask */ "./resources/js/helper/mask.js");
/* harmony import */ var _autocomplete__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./autocomplete */ "./resources/js/helper/autocomplete.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  onLoad: function onLoad(event) {
    (0,_modal__WEBPACK_IMPORTED_MODULE_0__.inicializarModal)();
    (0,_mask__WEBPACK_IMPORTED_MODULE_1__.createMasks)();
    (0,_autocomplete__WEBPACK_IMPORTED_MODULE_2__.enableAutoComplete)();
  },
  confirmationForm: function confirmationForm(form, title, text) {
    return swal({
      title: title,
      text: text,
      icon: "warning",
  ...
  confirmationDeleteWithAjax: function confirmationDeleteWithAjax(url, title, text) {
    return swal({
      title: title,
      text: text,
      icon: "warning",
      ...
      if (willDelete) {
        ...
        return axios["delete"](url).then(function () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createMasks": () => (/* binding */ createMasks)
/* harmony export */ });
/* harmony import */ var _MaskHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MaskHelper */ "./resources/js/helper/MaskHelper.js");
...
var createMasks = function createMasks() {
   ...
   * Mark: Para o número de uma OS
   */
  (0,_MaskHelper__WEBPACK_IMPORTED_MODULE_0__.createMask)(document.querySelector('.mask-numero-os'), {
    mask: '***00000000',
  ...
  (0,_MaskHelper__WEBPACK_IMPORTED_MODULE_0__.createMask)(document.querySelector('.mask-codigo-local'), {
    mask: '000.000.000'
  });
  /**
   * Mark: Para o código do local
  ...
  (0,_MaskHelper__WEBPACK_IMPORTED_MODULE_0__.createMask)(document.querySelector('.mask-codigo-supervisor'), {
    mask: '0000'
  });
  /**
   * Mark: Para o código do local
  ...
  (0,_MaskHelper__WEBPACK_IMPORTED_MODULE_0__.createMask)(document.querySelector('.mask-id'), {
    mask: '00000'
  });
  /**
  ...
  (0,_MaskHelper__WEBPACK_IMPORTED_MODULE_0__.createAllMaskFromDataInput)();
};
...
/* harmony export */   "inicializarModal": () => (/* binding */ inicializarModal)
/* harmony export */ });
/* harmony import */ var _autocomplete__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./autocomplete */ "./resources/js/helper/autocomplete.js");
  ...
  _createClass(Modal, [{
    ...
    value: function openUrl(url) {
      ...
      axios.get(this.url).then(function (r) {
        Array.from(document.querySelectorAll('script[ismodelscript]')).map(function (item) {
          item.remove();
        });
        /**
        ...
        var scripts = modalBody.getElementsByTagName("script");
        ...
        $(_this.id).modal({});
        (0,_autocomplete__WEBPACK_IMPORTED_MODULE_0__.enableAutoComplete)();
      })["catch"](function (error) {
        console.error(error);
...
var modalAjax = new Modal("#modal_open_ajax");
var modalAjaxAuxiliar = new Modal("#modal_auxiliar_open_ajax");
var modalAjaxSmall = new Modal("#modal_sm_open_ajax");
/**
 * Método para inicializar eventos da modal
 */

var inicializarModal = function inicializarModal() {
  /**
...
var activeModalEvent = function activeModalEvent(select, action) {
...
var openModalAjax = function openModalAjax(event, elemento) {
  event.preventDefault();
  var url = elemento.getAttribute("open-modal");
...
var openModalSmAjax = function openModalSmAjax(event, elemento) {
  event.preventDefault();
  var url = elemento.getAttribute("open-modal");
...
var openModalAuxiliarAjax = function openModalAuxiliarAjax(event, elemento) {
  event.preventDefault();
  var url = elemento.getAttribute("open-modal");
