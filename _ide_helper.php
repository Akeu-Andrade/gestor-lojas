...
namespace App\Business\Seguranca\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Perfil[]|Perfil create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Perfil[]|Perfil make($attributes = [])
    */
    class PerfilFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
